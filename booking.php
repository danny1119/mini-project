    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <h5> Choose your car type:  &nbsp;
            <input  type="radio" name="radio" value="ac" ng-model="myVar"> AC &nbsp;
            <input  type="radio" name="radio" value="non_ac" ng-model="myVar"> Non-AC
        ...
        <div ng-switch-default>
         ...
         <h5> Choose charge type:  &nbsp;
            <input type="radio" name="radio1" value="km"> per km(s) &nbsp;
            <input type="radio" name="radio1" value="days"> per day(s)
